...
class PyRobstrideActuator:
    def __new__(cls,ports:typing.Sequence[builtins.str], py_actuators_config:typing.Sequence[tuple[builtins.int, PyRobstrideActuatorConfig]]): ...
    def run_main_loop(self, interval_ms:builtins.int) -> builtins.bool:
        ...

    def disable(self, id:builtins.int) -> builtins.bool:
        ...

    def enable(self, id:builtins.int) -> builtins.bool:
        ...
...
class PyRobstrideActuatorCommand:
    ...
    def __new__(cls,actuator_id:builtins.int, position:typing.Optional[builtins.float], velocity:typing.Optional[builtins.float], torque:typing.Optional[builtins.float]): ...
...
class PyRobstrideConfigureRequest:
    ...
    def __new__(cls,actuator_id:builtins.int, kp:typing.Optional[builtins.float], kd:typing.Optional[builtins.float], max_torque:typing.Optional[builtins.float], torque_enabled:typing.Optional[builtins.bool], zero_position:typing.Optional[builtins.bool], new_actuator_id:typing.Optional[builtins.int]): ...
